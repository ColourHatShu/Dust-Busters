...
- [ ] **Cleaner "Get directions" link** on the job detail — Maps deep link to the service address (shown after the deposit reveals it). (IDEAS batch 3)
- [ ] **Admin "this month vs all-time" revenue** split on the dashboard. (IDEAS batch 3)
